        ...
        try:
            ...
            for s3_event in sns_message.get('Records', []):
                try:
                    ...
                    greyscale_key = f"greyscale/{filename}"

                    upload_to_s3(bucket_name, greyscale_key, greyscale_image)
                    print(f"Greyscale image uploaded to s3://{bucket_name}/{greyscale_key}")
